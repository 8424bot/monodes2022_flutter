    ...
    return Scaffold(
        ...
        body: SingleChildScrollView(
            ...
            child: Column(children: const [
              ...
              Text(
                "これはものづくりデザイン演習１で作成したOIT梅田キャンパス生専用学生生活支援アプリです\n"
              ...
              Text.rich(TextSpan(children: [
                ...
                TextSpan(
                  text: "様々なページへのリンクや情報を保存できるページです。右下のボタンをタップすると登録ができます。"
                      "リストの項目をタップすると詳細を確認でき、URLを登録していた場合はそのページに飛ぶことができます。項目を左にスライドすると編集と削除が行えます。\n",
                  style: TextStyle(fontSize: 15),
                ),
              ])),
              Text(
